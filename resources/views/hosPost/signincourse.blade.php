  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="card h-100 radius-border">
                ...
                <form class="" role="form" method="POST" action="">
      			...
      			<div class="card-body my-5">
     			  ...
     			  <div class="text-center">
     			    <h3 class="dark-grey-text mb-5"><strong>Send</strong></h3>
     			  </div>
        ...
        <form class="contactform px-md-1 mx-md-5 mx-lg-5-md" role="form" method="POST"
                    action="">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" id="nationality" name="nationality">
                          <option value="0">Select</option>
                                                                          <option value="SA" >Primary School</option>
                                                                          <option value="ET" >Preparatory School</option>
                                                                          <option value="AZ" >Secondary School</option>
                                                                          <option value="AM" >University</option>
                                                                          <option value="AW" >Employee</option>
                                                                          <option value="SA" >Unemployed</option>
                  ...
                  <div class="form-group">
                      <label for="nationality">Courses</label>
                      <select class="form-control" id="nationality" name="nationality">
                          <option value="0">Select</option>
                                                                          <option value="SA" > Band Aid</option>
                                                                          <option value="ET" >Natural Therapy</option>
                                                                          <option value="AZ" >intellectual disability </option>
                                                                          ...
                                                                          <div class="form-group">
                                                                            <label for="gander">Have You Ever Donated?</label>
                                                                            <select name="gander" class="form-control">
                                                                              <option selected>Select</option>
            ...
            <div class="text-center mb-3">
              <div class="text-center mb-3">
                ...
                <a href="signinv.html" button class="btn btn-main-primary btn-block btn-rounded z-depth-1a">
              Send Request
            </a>
              </div>
            </div>
